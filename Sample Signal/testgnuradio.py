...
class testgnuradio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testgnuradio")
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_throttle2_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(1694100000, self.samp_rate)




def main(top_block_cls=testgnuradio, options=None):
